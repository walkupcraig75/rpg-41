...
class Map {
	vector<vector<char>> view;//the stuff that actually gets printed to the screen
	vector<vector<vector<char>>> rooms;//stores all the rooms
	vector<vector<int>> layout;//stores how the rooms are arranged
	//file paths for rooms
